...
export default function FormPage() {
	...
	const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
		...
		// Get selected number of questions (radio)
		const numQuestions = formData.get("numQuestions") as string;

		// Get selected question types (checkboxes)
		const selectedQuestionTypes = formData.getAll("questionTypes") as string[];
		...
		try {
			...
			// Store the response data (you may want to use state management or localStorage)
			// For now, we'll pass it via URL params or store in sessionStorage
			sessionStorage.setItem("generatedQuestions", JSON.stringify(data));
